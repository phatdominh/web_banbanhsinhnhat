		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
				 <div class="col-sm-10">
					<div class="widget">
						<h4 class="widget-title">Thông tin iên Hệ</h4>
						<div>
							<div class="contact-info">
								<i class="fa fa-map-marker"></i>
								<p>Số nhà 30, Ngõ 268, phường Ngọc Thụy, quận Long Biên, thành phố Hà Nội</p>
								<p>Quý khách hàng có nhu cầu đặt hàng vui lòng liên hệ với chúng tôi theo Số Hotline: 0961 969 269</p>
							</div>
						</div>
					</div>
				  </div>
				...
				<div class="col-sm-3">
					<div class="widget">
						<h4 class="widget-title">Để Lại thông tin</h4>
