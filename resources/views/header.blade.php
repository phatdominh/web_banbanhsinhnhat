			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Số 30, Ngõ 268, Ngọc Thụy, Long Biên, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0961 969 269</a></li>
					</ul>
				</div>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">{{$product['qty']}} * <span>
                                               ...
                                               @else 	{{number_format($product['item']['promotion_price'])}} đồng @endif
          									</span></span>
										</div>
									</div>
								</div>
